 ...
 * Empployeereg.java
 *
 * Created on Jul 21, 2012, 11:23:44 PM
 */
 ...
 * @author laptop
 */
public class Empployeereg extends javax.swing.JFrame {

    /** Creates new form Empployeereg */
    public Empployeereg() {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(studentmanagement1.StudentManagement1App.class).getContext().getResourceMap(Empployeereg.class);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pursuing M.Tech", "M.Tech", "Pursuiing PhD", "PhD" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1999", "2000", "2001", "2002" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jLabel9, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 603, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                            .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 159, Short.MAX_VALUE)
                            .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            try {
               ...
               con = DriverManager.getConnection("jdbc:odbc:College Management");
                try {
                    String str = "insert into emplog(empname,empid,pass,add,contact,joining,educ,salary,email)"  +
                          " values(?,?,?,?,?,?,?,?,?)";
                    ...
                    if(jComboBox1.getSelectedItem().toString()=="Pursuing M.Tech"){
                    ps.setString(8, "20000/-");
                    }
                    else if(jComboBox1.getSelectedItem().toString() == "M.Tech")
                    {
                    ps.setString(8, "30000/-");
                    }
                    else if(jComboBox1.getSelectedItem().toString() == "Pursuiing PhD")
                    {
                    ps.setString(8, "40000/-");
                    }
                    else if(jComboBox1.getSelectedItem().toString() == "PhD")
                    {
                    ps.setString(8, "60000/-");
                    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Empployeereg().setVisible(true);
            }
        });
    }
